(function(App, React){
    ...
    App.Components.RedHillLeft = React.createClass({

        render: function(){
            return(
                <svg className="hill red-hill red-hill-left" style={{top: this.props.yOffset + 'px'}}>
                    <defs>
                        <linearGradient id="red_hill_left_gradient_1" gradientUnits="userSpaceOnUse" x1="501.75" y1="167.85000000000002" x2="633.45" y2="395.25" spreadMethod="pad">
                        ...
                        <linearGradient id="red_hill_left_gradient_2" gradientUnits="userSpaceOnUse" x1="512.975" y1="-77.25000000000001" x2="366.625" y2="277.65000000000003" spreadMethod="pad">
                            <stop  offset="0%" style={{stopColor:"#333333"}}/>

                            <stop  offset="100%" style={{stopColor:"#000000"}}/>
                        </linearGradient>

                        <linearGradient id="red_hill_left_gradient_3" gradientUnits="userSpaceOnUse" x1="481.025" y1="-63.25" x2="412.975" y2="128.65" spreadMethod="pad">
                    ...
                    <g>
                        <path fill="url(#red_hill_left_gradient_1)" stroke="none" d="
                            M 1106 252
                        ...
                        <path fill="url(#red_hill_left_gradient_2)" stroke="none" d="
                            M 1100.7 252
                        ...
                        <path fill="url(#red_hill_left_gradient_3)" stroke="none" d="
                            M 1084.75 252
