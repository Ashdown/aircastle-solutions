        ...
        render: function(){
            return(
                <svg className="cloud left-cloud">
                    ...
                    <defs>
                        <linearGradient id="left_cloud_gradient_1" gradientUnits="userSpaceOnUse" x1="100.92499999999998" y1="30.38749999999999" x2="222.775" y2="152.3125" spreadMethod="pad">
                        ...
                        <linearGradient id="left_cloud_gradient_2" gradientUnits="userSpaceOnUse" x1="265.0625" y1="110.575" x2="104.63749999999999" y2="270.52500000000003" spreadMethod="pad">
                            <stop  offset="0%" style={{stopColor:"#333333"}}/>

                            <stop  offset="100%" style={{stopColor:"#000000"}}/>
                        </linearGradient>

                        <linearGradient id="left_cloud_gradient_3" gradientUnits="userSpaceOnUse" x1="262.3125" y1="113.41250000000001" x2="108.08749999999998" y2="267.1875" spreadMethod="pad">
                            <stop  offset="0%" style={{stopColor:"#77433A"}}/>

                            <stop  offset="100%" style={{stopColor:"#231311"}}/>
                        </linearGradient>

                        <linearGradient id="left_cloud_gradient_4" gradientUnits="userSpaceOnUse" x1="210.0125" y1="140.45" x2="365.58750000000003" y2="269.05" spreadMethod="pad">
                            <stop  offset="0%" style={{stopColor:"#513717"}}/>
                    ...
                    <g id="Layer0_0_FILL">
                        ...
                        <path fill="url(#left_cloud_gradient_3)" stroke="none" d="
                            M 231 131.6
                        ...
                        <path fill="url(#left_cloud_gradient_4)" stroke="none" d="
                            M 333.1 336.9
